...
4. Pour rendre le fichier executable, ecrire : **chmod +x C-Wire.sh**
5. Exécuter le script shell. Syntaxe générale : **./C-Wire.sh <fichier_csv> <type_station> <type_consommateur> [id_centrale]**
